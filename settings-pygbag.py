...
# Musica y Sonidos
background_music = {
    "music": [str(SOUNDS_DIR / "bensound-prism.ogg")],
    "sounds": {
        "player": {},
        "enemies": {},
        "environment": {},
        "shooting": {
            "shooting_generic": str(SOUNDS_DIR / "shoot1.ogg"),
            "energy_ball": str(SOUNDS_DIR / "energy_ball.ogg"),
        },
        "explosions": str(SOUNDS_DIR / "explosion.ogg"),
    },
}
